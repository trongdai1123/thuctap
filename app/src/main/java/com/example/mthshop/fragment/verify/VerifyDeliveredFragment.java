...
import com.example.mthshop.databinding.FragmentVerifyDeliveredBinding;
...
public class VerifyDeliveredFragment extends Fragment {
    private FragmentVerifyDeliveredBinding thisFragment;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        thisFragment = FragmentVerifyDeliveredBinding.inflate(getLayoutInflater());
    ...
    private void setRecyclerView() {
        if (!listProduct.isEmpty())
            thisFragment.fVerifyDeliveredTvEmpty.setVisibility(View.GONE);

        myBillAdapter = new VerifyBillsAdapter(listProduct, getActivity(), 1);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity());
        thisFragment.fVerifyDeliveredRecyclerView.setHasFixedSize(true);
        thisFragment.fVerifyDeliveredRecyclerView.setLayoutManager(linearLayoutManager);
        thisFragment.fVerifyDeliveredRecyclerView.setAdapter(myBillAdapter);
    }
}
